...
remove_dir = ['.','hallib/Src','hallib/Src/Legacy','build', \
            'usb/Class/CustomHID','usb/Class/MSC','usb/Core/Src' \
            ]
...
C_SOURCES += 	 \\
		hallib/Src/stm32f1xx_hal_rcc.c \\
		hallib/Src/stm32f1xx_hal_rcc_ex.c \\
		hallib/Src/stm32f1xx_hal_gpio.c \\
		hallib/Src/stm32f1xx_hal_dma.c \\
		hallib/Src/stm32f1xx_hal_pwr.c \\
		hallib/Src/stm32f1xx_hal_cortex.c \\
		hallib/Src/stm32f1xx_hal.c \\
		hallib/Src/stm32f1xx_hal_tim.c \\
		hallib/Src/stm32f1xx_hal_tim_ex.c \\
		hallib/Src/stm32f1xx_hal_flash.c \\
		hallib/Src/stm32f1xx_hal_flash_ex.c \\
		hallib/Src/stm32f1xx_ll_usb.c \\
		hallib/Src/stm32f1xx_hal_pcd.c \\
		hallib/Src/stm32f1xx_hal_pcd_ex.c \\
		hallib/Src/stm32f1xx_hal_uart.c \\
		hallib/Src/stm32f1xx_hal_spi.c \\
...
asm_sources = 'core/gcc/startup_stm32f103xb.s'
f_src.write('\n\nASM_SOURCES =  \\\n' + asm_sources)
